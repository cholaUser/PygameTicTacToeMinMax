...
-wykonanie ruchu przez program z wykorzystaniem algorytmu min_max - dowolny przycisk klawiatury.
...
-evaluation_func() - funkcja określająca jak dobra jest pozycja graczy w danym momencie gry
